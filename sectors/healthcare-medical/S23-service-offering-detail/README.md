...
Treatment / Medical Service Detail
...
| Variant | Territory |
| --- | --- |
| `HC-S23-001` | Universal / Safe |
| `HC-S23-002` | Premium / Editorial |
| `HC-S23-003` | Dense / Information-heavy |
| `HC-S23-004` | Conversion-led |
| `HC-S23-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S02 Medical Services (`S02-medical-services/`).
