...
Care Pathway / Case Context Detail
...
| Variant | Territory |
| --- | --- |
| `HC-S24-001` | Universal / Safe |
| `HC-S24-002` | Premium / Editorial |
| `HC-S24-003` | Dense / Information-heavy |
| `HC-S24-004` | Conversion-led |
| `HC-S24-005` | Sector-native / Distinctive |
