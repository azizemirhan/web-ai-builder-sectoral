...
| Variant | Territory |
| --- | --- |
| `HC-S26-001` | Universal / Safe |
| `HC-S26-002` | Premium / Editorial |
| `HC-S26-003` | Dense / Information-heavy |
| `HC-S26-004` | Conversion-led |
| `HC-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S03 Doctors Specialists (`S03-doctors-specialists/`).
