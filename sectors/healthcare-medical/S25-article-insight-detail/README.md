...
Health Article / Patient Resource Detail
...
| Variant | Territory |
| --- | --- |
| `HC-S25-001` | Universal / Safe |
| `HC-S25-002` | Premium / Editorial |
| `HC-S25-003` | Dense / Information-heavy |
| `HC-S25-004` | Conversion-led |
| `HC-S25-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S15 Patient Resources (`S15-patient-resources/`).
