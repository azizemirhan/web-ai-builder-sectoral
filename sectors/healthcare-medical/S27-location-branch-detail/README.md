...
Clinic / Department Location Detail
...
| Variant | Territory |
| --- | --- |
| `HC-S27-001` | Universal / Safe |
| `HC-S27-002` | Premium / Editorial |
| `HC-S27-003` | Dense / Information-heavy |
| `HC-S27-004` | Conversion-led |
| `HC-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S14 Locations Departments (`S14-locations-departments/`).
