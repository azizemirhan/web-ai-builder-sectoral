...
| Variant | Territory |
| --- | --- |
| `HOT-S27-001` | Universal / Safe |
| `HOT-S27-002` | Premium / Editorial |
| `HOT-S27-003` | Dense / Information-heavy |
| `HOT-S27-004` | Conversion-led |
| `HOT-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S11 Location Map (`S11-location-map/`).
