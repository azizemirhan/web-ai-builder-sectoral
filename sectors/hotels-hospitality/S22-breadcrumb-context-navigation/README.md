...
| Variant | Territory |
| --- | --- |
| `HOT-S22-001` | Universal / Safe |
| `HOT-S22-002` | Premium / Editorial |
| `HOT-S22-003` | Dense / Information-heavy |
| `HOT-S22-004` | Conversion-led |
| `HOT-S22-005` | Sector-native / Distinctive |
