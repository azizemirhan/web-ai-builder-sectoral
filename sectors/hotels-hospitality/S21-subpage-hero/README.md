...
| Variant | Territory |
| --- | --- |
| `HOT-S21-001` | Universal / Safe |
| `HOT-S21-002` | Premium / Editorial |
| `HOT-S21-003` | Dense / Information-heavy |
| `HOT-S21-004` | Conversion-led |
| `HOT-S21-005` | Sector-native / Distinctive |
