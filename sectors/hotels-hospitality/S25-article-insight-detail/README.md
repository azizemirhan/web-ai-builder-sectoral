...
Destination Guide / Story Detail
...
| Variant | Territory |
| --- | --- |
| `HOT-S25-001` | Universal / Safe |
| `HOT-S25-002` | Premium / Editorial |
| `HOT-S25-003` | Dense / Information-heavy |
| `HOT-S25-004` | Conversion-led |
| `HOT-S25-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S19 Newsletter Offers (`S19-newsletter-offers/`).
