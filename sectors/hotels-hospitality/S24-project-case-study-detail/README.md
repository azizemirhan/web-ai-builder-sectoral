...
Event / Group Programme Case Detail
...
Room, rate and booking templates are out of S21-S27 scope and reserved for a future S28+ extension. This role covers event and group programme work rather than inventory.
...
| Variant | Territory |
| --- | --- |
| `HOT-S24-001` | Universal / Safe |
| `HOT-S24-002` | Premium / Editorial |
| `HOT-S24-003` | Dense / Information-heavy |
| `HOT-S24-004` | Conversion-led |
| `HOT-S24-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S06 Hotel Gallery (`S06-hotel-gallery/`).
