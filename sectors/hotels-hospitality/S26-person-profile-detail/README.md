...
| Variant | Territory |
| --- | --- |
| `HOT-S26-001` | Universal / Safe |
| `HOT-S26-002` | Premium / Editorial |
| `HOT-S26-003` | Dense / Information-heavy |
| `HOT-S26-004` | Conversion-led |
| `HOT-S26-005` | Sector-native / Distinctive |
