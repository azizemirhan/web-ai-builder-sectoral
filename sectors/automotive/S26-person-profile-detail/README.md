...
Technician / Sales Specialist Profile
...
| Variant | Territory |
| --- | --- |
| `AUTO-S26-001` | Universal / Safe |
| `AUTO-S26-002` | Premium / Editorial |
| `AUTO-S26-003` | Dense / Information-heavy |
| `AUTO-S26-004` | Conversion-led |
| `AUTO-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S11 Team (`S11-team/`).
