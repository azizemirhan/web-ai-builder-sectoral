...
| Variant | Territory |
| --- | --- |
| `AUTO-S25-001` | Universal / Safe |
| `AUTO-S25-002` | Premium / Editorial |
| `AUTO-S25-003` | Dense / Information-heavy |
| `AUTO-S25-004` | Conversion-led |
| `AUTO-S25-005` | Sector-native / Distinctive |
