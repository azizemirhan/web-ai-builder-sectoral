...
Fleet / Custom Build Case Detail
...
Most depth in this sector sits in vehicle and inventory templates, which are out of S21-S27 scope and reserved for a future S28+ extension. This role stays a record of completed work, not a vehicle page.
...
| Variant | Territory |
| --- | --- |
| `AUTO-S24-001` | Universal / Safe |
| `AUTO-S24-002` | Premium / Editorial |
| `AUTO-S24-003` | Dense / Information-heavy |
| `AUTO-S24-004` | Conversion-led |
| `AUTO-S24-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S03 Featured Vehicles (`S03-featured-vehicles/`).
