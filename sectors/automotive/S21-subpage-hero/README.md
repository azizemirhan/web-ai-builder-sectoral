...
| Variant | Territory |
| --- | --- |
| `AUTO-S21-001` | Universal / Safe |
| `AUTO-S21-002` | Premium / Editorial |
| `AUTO-S21-003` | Dense / Information-heavy |
| `AUTO-S21-004` | Conversion-led |
| `AUTO-S21-005` | Sector-native / Distinctive |
