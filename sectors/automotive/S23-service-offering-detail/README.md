...
| Variant | Territory |
| --- | --- |
| `AUTO-S23-001` | Universal / Safe |
| `AUTO-S23-002` | Premium / Editorial |
| `AUTO-S23-003` | Dense / Information-heavy |
| `AUTO-S23-004` | Conversion-led |
| `AUTO-S23-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S02 Vehicle Service Categories (`S02-vehicle-service-categories/`).
