...
Dealership / Service Centre Detail
...
| Variant | Territory |
| --- | --- |
| `AUTO-S27-001` | Universal / Safe |
| `AUTO-S27-002` | Premium / Editorial |
| `AUTO-S27-003` | Dense / Information-heavy |
| `AUTO-S27-004` | Conversion-led |
| `AUTO-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S10 Dealership Locations (`S10-dealership-locations/`).
