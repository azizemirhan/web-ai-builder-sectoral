...
Office / Support Location Detail
...
| Variant | Territory |
| --- | --- |
| `IT-S27-001` | Universal / Safe |
| `IT-S27-002` | Premium / Editorial |
| `IT-S27-003` | Dense / Information-heavy |
| `IT-S27-004` | Conversion-led |
| `IT-S27-005` | Sector-native / Distinctive |
