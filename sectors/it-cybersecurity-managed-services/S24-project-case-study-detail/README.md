...
Case Study / Implementation Detail
...
Client naming and incident detail are frequently restricted by contract. Scoped to anonymised implementation context.
...
| Variant | Territory |
| --- | --- |
| `IT-S24-001` | Universal / Safe |
| `IT-S24-002` | Premium / Editorial |
| `IT-S24-003` | Dense / Information-heavy |
| `IT-S24-004` | Conversion-led |
| `IT-S24-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S10 Case Studies (`S10-case-studies/`).
