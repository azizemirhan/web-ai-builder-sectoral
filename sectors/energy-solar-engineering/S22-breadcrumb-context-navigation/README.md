...
| Variant | Territory |
| --- | --- |
| `ENG-S22-001` | Universal / Safe |
| `ENG-S22-002` | Premium / Editorial |
| `ENG-S22-003` | Dense / Information-heavy |
| `ENG-S22-004` | Conversion-led |
| `ENG-S22-005` | Sector-native / Distinctive |
