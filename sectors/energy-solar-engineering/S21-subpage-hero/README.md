...
| Variant | Territory |
| --- | --- |
| `ENG-S21-001` | Universal / Safe |
| `ENG-S21-002` | Premium / Editorial |
| `ENG-S21-003` | Dense / Information-heavy |
| `ENG-S21-004` | Conversion-led |
| `ENG-S21-005` | Sector-native / Distinctive |
