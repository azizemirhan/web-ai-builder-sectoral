...
Office / Service Location Detail
...
| Variant | Territory |
| --- | --- |
| `ENG-S27-001` | Universal / Safe |
| `ENG-S27-002` | Premium / Editorial |
| `ENG-S27-003` | Dense / Information-heavy |
| `ENG-S27-004` | Conversion-led |
| `ENG-S27-005` | Sector-native / Distinctive |
