...
| Variant | Territory |
| --- | --- |
| `ENG-S26-001` | Universal / Safe |
| `ENG-S26-002` | Premium / Editorial |
| `ENG-S26-003` | Dense / Information-heavy |
| `ENG-S26-004` | Conversion-led |
| `ENG-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S08 Engineering Process (`S08-engineering-process/`).
