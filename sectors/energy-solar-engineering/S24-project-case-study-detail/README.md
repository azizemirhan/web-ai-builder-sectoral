...
| Variant | Territory |
| --- | --- |
| `ENG-S24-001` | Universal / Safe |
| `ENG-S24-002` | Premium / Editorial |
| `ENG-S24-003` | Dense / Information-heavy |
| `ENG-S24-004` | Conversion-led |
| `ENG-S24-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S04 Projects (`S04-projects/`).
