...
| Variant | Territory |
| --- | --- |
| `LOG-S21-001` | Universal / Safe |
| `LOG-S21-002` | Premium / Editorial |
| `LOG-S21-003` | Dense / Information-heavy |
| `LOG-S21-004` | Conversion-led |
| `LOG-S21-005` | Sector-native / Distinctive |
