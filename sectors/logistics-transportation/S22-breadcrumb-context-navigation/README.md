...
| Variant | Territory |
| --- | --- |
| `LOG-S22-001` | Universal / Safe |
| `LOG-S22-002` | Premium / Editorial |
| `LOG-S22-003` | Dense / Information-heavy |
| `LOG-S22-004` | Conversion-led |
| `LOG-S22-005` | Sector-native / Distinctive |
