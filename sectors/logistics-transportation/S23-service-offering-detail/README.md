...
| Variant | Territory |
| --- | --- |
| `LOG-S23-001` | Universal / Safe |
| `LOG-S23-002` | Premium / Editorial |
| `LOG-S23-003` | Dense / Information-heavy |
| `LOG-S23-004` | Conversion-led |
| `LOG-S23-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S02 Logistics Services (`S02-logistics-services/`).
