...
| Variant | Territory |
| --- | --- |
| `LOG-S26-001` | Universal / Safe |
| `LOG-S26-002` | Premium / Editorial |
| `LOG-S26-003` | Dense / Information-heavy |
| `LOG-S26-004` | Conversion-led |
| `LOG-S26-005` | Sector-native / Distinctive |
