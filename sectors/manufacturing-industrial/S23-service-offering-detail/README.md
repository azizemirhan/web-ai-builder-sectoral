...
Capability / Manufacturing Service Detail
...
| Variant | Territory |
| --- | --- |
| `MFG-S23-001` | Universal / Safe |
| `MFG-S23-002` | Premium / Editorial |
| `MFG-S23-003` | Dense / Information-heavy |
| `MFG-S23-004` | Conversion-led |
| `MFG-S23-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S02 Capabilities (`S02-capabilities/`).
