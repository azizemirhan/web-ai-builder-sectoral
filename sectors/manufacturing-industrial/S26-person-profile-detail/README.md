...
| Variant | Territory |
| --- | --- |
| `MFG-S26-001` | Universal / Safe |
| `MFG-S26-002` | Premium / Editorial |
| `MFG-S26-003` | Dense / Information-heavy |
| `MFG-S26-004` | Conversion-led |
| `MFG-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S18 Engineering Team (`S18-engineering-team/`).
