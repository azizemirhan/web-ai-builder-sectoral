...
| Variant | Territory |
| --- | --- |
| `MFG-S21-001` | Universal / Safe |
| `MFG-S21-002` | Premium / Editorial |
| `MFG-S21-003` | Dense / Information-heavy |
| `MFG-S21-004` | Conversion-led |
| `MFG-S21-005` | Sector-native / Distinctive |
