...
| Variant | Territory |
| --- | --- |
| `MFG-S24-001` | Universal / Safe |
| `MFG-S24-002` | Premium / Editorial |
| `MFG-S24-003` | Dense / Information-heavy |
| `MFG-S24-004` | Conversion-led |
| `MFG-S24-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S11 Projects Applications (`S11-projects-applications/`).
