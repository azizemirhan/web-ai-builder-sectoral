...
| Variant | Territory |
| --- | --- |
| `MFG-S27-001` | Universal / Safe |
| `MFG-S27-002` | Premium / Editorial |
| `MFG-S27-003` | Dense / Information-heavy |
| `MFG-S27-004` | Conversion-led |
| `MFG-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S06 Facilities Infrastructure (`S06-facilities-infrastructure/`).
