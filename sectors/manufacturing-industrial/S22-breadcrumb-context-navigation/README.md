...
| Variant | Territory |
| --- | --- |
| `MFG-S22-001` | Universal / Safe |
| `MFG-S22-002` | Premium / Editorial |
| `MFG-S22-003` | Dense / Information-heavy |
| `MFG-S22-004` | Conversion-led |
| `MFG-S22-005` | Sector-native / Distinctive |
