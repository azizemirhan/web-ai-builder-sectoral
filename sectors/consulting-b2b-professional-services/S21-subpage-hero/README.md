...
| Variant | Territory |
| --- | --- |
| `CONS-S21-001` | Universal / Safe |
| `CONS-S21-002` | Premium / Editorial |
| `CONS-S21-003` | Dense / Information-heavy |
| `CONS-S21-004` | Conversion-led |
| `CONS-S21-005` | Sector-native / Distinctive |
