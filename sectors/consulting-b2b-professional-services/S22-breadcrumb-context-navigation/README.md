...
| Variant | Territory |
| --- | --- |
| `CONS-S22-001` | Universal / Safe |
| `CONS-S22-002` | Premium / Editorial |
| `CONS-S22-003` | Dense / Information-heavy |
| `CONS-S22-004` | Conversion-led |
| `CONS-S22-005` | Sector-native / Distinctive |
