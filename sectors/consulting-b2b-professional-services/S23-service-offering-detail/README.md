...
| Variant | Territory |
| --- | --- |
| `CONS-S23-001` | Universal / Safe |
| `CONS-S23-002` | Premium / Editorial |
| `CONS-S23-003` | Dense / Information-heavy |
| `CONS-S23-004` | Conversion-led |
| `CONS-S23-005` | Sector-native / Distinctive |
