...
| Variant | Territory |
| --- | --- |
| `FIN-S21-001` | Universal / Safe |
| `FIN-S21-002` | Premium / Editorial |
| `FIN-S21-003` | Dense / Information-heavy |
| `FIN-S21-004` | Conversion-led |
| `FIN-S21-005` | Sector-native / Distinctive |
