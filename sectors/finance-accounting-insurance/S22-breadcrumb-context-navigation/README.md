...
| Variant | Territory |
| --- | --- |
| `FIN-S22-001` | Universal / Safe |
| `FIN-S22-002` | Premium / Editorial |
| `FIN-S22-003` | Dense / Information-heavy |
| `FIN-S22-004` | Conversion-led |
| `FIN-S22-005` | Sector-native / Distinctive |
