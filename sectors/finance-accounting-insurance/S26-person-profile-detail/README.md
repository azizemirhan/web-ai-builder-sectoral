...
| Variant | Territory |
| --- | --- |
| `FIN-S26-001` | Universal / Safe |
| `FIN-S26-002` | Premium / Editorial |
| `FIN-S26-003` | Dense / Information-heavy |
| `FIN-S26-004` | Conversion-led |
| `FIN-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S04 Advisors Experts (`S04-advisors-experts/`).
