...
Financial Insight / Guidance Detail
...
| Variant | Territory |
| --- | --- |
| `FIN-S25-001` | Universal / Safe |
| `FIN-S25-002` | Premium / Editorial |
| `FIN-S25-003` | Dense / Information-heavy |
| `FIN-S25-004` | Conversion-led |
| `FIN-S25-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S13 Resources Guides (`S13-resources-guides/`).
