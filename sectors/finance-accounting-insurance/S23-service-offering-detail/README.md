...
Advisory / Financial Service Detail
...
| Variant | Territory |
| --- | --- |
| `FIN-S23-001` | Universal / Safe |
| `FIN-S23-002` | Premium / Editorial |
| `FIN-S23-003` | Dense / Information-heavy |
| `FIN-S23-004` | Conversion-led |
| `FIN-S23-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S02 Services Solutions (`S02-services-solutions/`).
