...
| Variant | Territory |
| --- | --- |
| `FIN-S27-001` | Universal / Safe |
| `FIN-S27-002` | Premium / Editorial |
| `FIN-S27-003` | Dense / Information-heavy |
| `FIN-S27-004` | Conversion-led |
| `FIN-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S18 Locations Offices (`S18-locations-offices/`).
