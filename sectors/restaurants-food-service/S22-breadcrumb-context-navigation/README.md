...
| Variant | Territory |
| --- | --- |
| `REST-S22-001` | Universal / Safe |
| `REST-S22-002` | Premium / Editorial |
| `REST-S22-003` | Dense / Information-heavy |
| `REST-S22-004` | Conversion-led |
| `REST-S22-005` | Sector-native / Distinctive |
