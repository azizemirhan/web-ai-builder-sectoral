...
| Variant | Territory |
| --- | --- |
| `REST-S26-001` | Universal / Safe |
| `REST-S26-002` | Premium / Editorial |
| `REST-S26-003` | Dense / Information-heavy |
| `REST-S26-004` | Conversion-led |
| `REST-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S06 Chef Team (`S06-chef-team/`).
