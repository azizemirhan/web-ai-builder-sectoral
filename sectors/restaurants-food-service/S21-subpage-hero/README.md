...
| Variant | Territory |
| --- | --- |
| `REST-S21-001` | Universal / Safe |
| `REST-S21-002` | Premium / Editorial |
| `REST-S21-003` | Dense / Information-heavy |
| `REST-S21-004` | Conversion-led |
| `REST-S21-005` | Sector-native / Distinctive |
