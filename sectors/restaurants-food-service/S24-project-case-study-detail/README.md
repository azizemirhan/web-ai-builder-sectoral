...
Private Event / Collaboration Case Detail
...
Limited applicability. Menu and dish templates are out of S21-S27 scope. This role applies mainly to private events, residencies and collaborations, and may go unused by a single-site restaurant.
...
| Variant | Territory |
| --- | --- |
| `REST-S24-001` | Universal / Safe |
| `REST-S24-002` | Premium / Editorial |
| `REST-S24-003` | Dense / Information-heavy |
| `REST-S24-004` | Conversion-led |
| `REST-S24-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S08 Gallery (`S08-gallery/`).
