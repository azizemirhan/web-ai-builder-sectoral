...
| Variant | Territory |
| --- | --- |
| `REST-S27-001` | Universal / Safe |
| `REST-S27-002` | Premium / Editorial |
| `REST-S27-003` | Dense / Information-heavy |
| `REST-S27-004` | Conversion-led |
| `REST-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S10 Location Hours (`S10-location-hours/`).
