...
| Variant | Territory |
| --- | --- |
| `REST-S25-001` | Universal / Safe |
| `REST-S25-002` | Premium / Editorial |
| `REST-S25-003` | Dense / Information-heavy |
| `REST-S25-004` | Conversion-led |
| `REST-S25-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S18 Newsletter (`S18-newsletter/`).
