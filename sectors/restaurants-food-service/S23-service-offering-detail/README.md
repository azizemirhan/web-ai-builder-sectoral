...
Dining / Private Event Offering Detail
...
| Variant | Territory |
| --- | --- |
| `REST-S23-001` | Universal / Safe |
| `REST-S23-002` | Premium / Editorial |
| `REST-S23-003` | Dense / Information-heavy |
| `REST-S23-004` | Conversion-led |
| `REST-S23-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S02 Menu Preview (`S02-menu-preview/`).
