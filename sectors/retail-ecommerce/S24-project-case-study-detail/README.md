...
Brand Collaboration / Campaign Case Detail
...
Limited applicability. Retail work is usually presented as product or campaign imagery rather than as a case study. The role is retained and may go unused.
...
| Variant | Territory |
| --- | --- |
| `RET-S24-001` | Universal / Safe |
| `RET-S24-002` | Premium / Editorial |
| `RET-S24-003` | Dense / Information-heavy |
| `RET-S24-004` | Conversion-led |
| `RET-S24-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S02 Featured Products (`S02-featured-products/`).
