...
Editorial / Lookbook Article Detail
...
| Variant | Territory |
| --- | --- |
| `RET-S25-001` | Universal / Safe |
| `RET-S25-002` | Premium / Editorial |
| `RET-S25-003` | Dense / Information-heavy |
| `RET-S25-004` | Conversion-led |
| `RET-S25-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S16 Newsletter Alerts (`S16-newsletter-alerts/`).
