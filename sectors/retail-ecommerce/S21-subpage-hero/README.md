...
| Variant | Territory |
| --- | --- |
| `RET-S21-001` | Universal / Safe |
| `RET-S21-002` | Premium / Editorial |
| `RET-S21-003` | Dense / Information-heavy |
| `RET-S21-004` | Conversion-led |
| `RET-S21-005` | Sector-native / Distinctive |
