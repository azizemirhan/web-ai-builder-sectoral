...
Optional in this sector. Retained for founder, designer and maker stories rather than a staff directory.
...
| Variant | Territory |
| --- | --- |
| `RET-S26-001` | Universal / Safe |
| `RET-S26-002` | Premium / Editorial |
| `RET-S26-003` | Dense / Information-heavy |
| `RET-S26-004` | Conversion-led |
| `RET-S26-005` | Sector-native / Distinctive |
