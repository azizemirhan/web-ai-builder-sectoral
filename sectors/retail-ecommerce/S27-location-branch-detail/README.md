...
| Variant | Territory |
| --- | --- |
| `RET-S27-001` | Universal / Safe |
| `RET-S27-002` | Premium / Editorial |
| `RET-S27-003` | Dense / Information-heavy |
| `RET-S27-004` | Conversion-led |
| `RET-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S14 Store Locations (`S14-store-locations/`).
