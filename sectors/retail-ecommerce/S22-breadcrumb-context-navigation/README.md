...
| Variant | Territory |
| --- | --- |
| `RET-S22-001` | Universal / Safe |
| `RET-S22-002` | Premium / Editorial |
| `RET-S22-003` | Dense / Information-heavy |
| `RET-S22-004` | Conversion-led |
| `RET-S22-005` | Sector-native / Distinctive |
