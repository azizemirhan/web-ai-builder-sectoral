...
Student Service / Programme Support Detail
...
The primary depth page in this sector is the programme or course itself, a likely future S28+ sector-native template. This role is scoped to the services around it: admissions, student support, careers and access.
...
Nearest existing section in this sector: S02 Programs Courses (`S02-programs-courses/`).
