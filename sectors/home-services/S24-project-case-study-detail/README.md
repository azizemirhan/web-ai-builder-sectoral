...
| Variant | Territory |
| --- | --- |
| `HOME-S24-001` | Universal / Safe |
| `HOME-S24-002` | Premium / Editorial |
| `HOME-S24-003` | Dense / Information-heavy |
| `HOME-S24-004` | Conversion-led |
| `HOME-S24-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S07 How It Works (`S07-how-it-works/`).
