...
Branch / Service Location Detail
...
| Variant | Territory |
| --- | --- |
| `HOME-S27-001` | Universal / Safe |
| `HOME-S27-002` | Premium / Editorial |
| `HOME-S27-003` | Dense / Information-heavy |
| `HOME-S27-004` | Conversion-led |
| `HOME-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S18 Branches Locations (`S18-branches-locations/`).
