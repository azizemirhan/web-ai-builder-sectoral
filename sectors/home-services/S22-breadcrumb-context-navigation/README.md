...
| Variant | Territory |
| --- | --- |
| `HOME-S22-001` | Universal / Safe |
| `HOME-S22-002` | Premium / Editorial |
| `HOME-S22-003` | Dense / Information-heavy |
| `HOME-S22-004` | Conversion-led |
| `HOME-S22-005` | Sector-native / Distinctive |
