...
| Variant | Territory |
| --- | --- |
| `HOME-S25-001` | Universal / Safe |
| `HOME-S25-002` | Premium / Editorial |
| `HOME-S25-003` | Dense / Information-heavy |
| `HOME-S25-004` | Conversion-led |
| `HOME-S25-005` | Sector-native / Distinctive |
