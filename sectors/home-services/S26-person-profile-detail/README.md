...
| Variant | Territory |
| --- | --- |
| `HOME-S26-001` | Universal / Safe |
| `HOME-S26-002` | Premium / Editorial |
| `HOME-S26-003` | Dense / Information-heavy |
| `HOME-S26-004` | Conversion-led |
| `HOME-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S08 Technicians Team (`S08-technicians-team/`).
