...
| Variant | Territory |
| --- | --- |
| `HOME-S21-001` | Universal / Safe |
| `HOME-S21-002` | Premium / Editorial |
| `HOME-S21-003` | Dense / Information-heavy |
| `HOME-S21-004` | Conversion-led |
| `HOME-S21-005` | Sector-native / Distinctive |
