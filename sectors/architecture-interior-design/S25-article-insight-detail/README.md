...
| `ARC-S25-003` | Dense / Information-heavy |
| `ARC-S25-004` | Conversion-led |
| `ARC-S25-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S09 Awards & Publications (`S09-awards-publications/`).
