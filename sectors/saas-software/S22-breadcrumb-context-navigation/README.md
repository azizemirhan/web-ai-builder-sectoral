...
| Variant | Territory |
| --- | --- |
| `SAAS-S22-001` | Universal / Safe |
| `SAAS-S22-002` | Premium / Editorial |
| `SAAS-S22-003` | Dense / Information-heavy |
| `SAAS-S22-004` | Conversion-led |
| `SAAS-S22-005` | Sector-native / Distinctive |
