...
| Variant | Territory |
| --- | --- |
| `SAAS-S23-001` | Universal / Safe |
| `SAAS-S23-002` | Premium / Editorial |
| `SAAS-S23-003` | Dense / Information-heavy |
| `SAAS-S23-004` | Conversion-led |
| `SAAS-S23-005` | Sector-native / Distinctive |
