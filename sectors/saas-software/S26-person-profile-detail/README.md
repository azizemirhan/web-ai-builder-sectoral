...
Optional in this sector. Retained for leadership pages and article bylines rather than a full staff directory.
...
| Variant | Territory |
| --- | --- |
| `SAAS-S26-001` | Universal / Safe |
| `SAAS-S26-002` | Premium / Editorial |
| `SAAS-S26-003` | Dense / Information-heavy |
| `SAAS-S26-004` | Conversion-led |
| `SAAS-S26-005` | Sector-native / Distinctive |
