...
| Variant | Territory |
| --- | --- |
| `SAAS-S21-001` | Universal / Safe |
| `SAAS-S21-002` | Premium / Editorial |
| `SAAS-S21-003` | Dense / Information-heavy |
| `SAAS-S21-004` | Conversion-led |
| `SAAS-S21-005` | Sector-native / Distinctive |
