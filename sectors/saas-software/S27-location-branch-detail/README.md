...
Office / Company Location Detail
...
Limited applicability. Many software companies are distributed and publish no location page. The role is retained in the scaffold and will often go unused.
...
| Variant | Territory |
| --- | --- |
| `SAAS-S27-001` | Universal / Safe |
| `SAAS-S27-002` | Premium / Editorial |
| `SAAS-S27-003` | Dense / Information-heavy |
| `SAAS-S27-004` | Conversion-led |
| `SAAS-S27-005` | Sector-native / Distinctive |
