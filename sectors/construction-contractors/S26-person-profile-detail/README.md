...
| `CON-S26-003` | Dense / Information-heavy |
| `CON-S26-004` | Conversion-led |
| `CON-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S11 Leadership Team (`S11-leadership-team/`).
