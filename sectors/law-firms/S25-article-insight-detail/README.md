...
| Variant | Territory |
| --- | --- |
| `LAW-S25-001` | Universal / Safe |
| `LAW-S25-002` | Premium / Editorial |
| `LAW-S25-003` | Dense / Information-heavy |
| `LAW-S25-004` | Conversion-led |
| `LAW-S25-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S10 Insights Publications (`S10-insights-publications/`).
