...
| Variant | Territory |
| --- | --- |
| `LAW-S26-001` | Universal / Safe |
| `LAW-S26-002` | Premium / Editorial |
| `LAW-S26-003` | Dense / Information-heavy |
| `LAW-S26-004` | Conversion-led |
| `LAW-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S03 Attorneys (`S03-attorneys/`).
