...
| Variant | Territory |
| --- | --- |
| `LAW-S27-001` | Universal / Safe |
| `LAW-S27-002` | Premium / Editorial |
| `LAW-S27-003` | Dense / Information-heavy |
| `LAW-S27-004` | Conversion-led |
| `LAW-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S13 Offices Locations (`S13-offices-locations/`).
