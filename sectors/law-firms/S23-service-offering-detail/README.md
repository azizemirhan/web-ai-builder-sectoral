...
Practice Area / Legal Service Detail
...
| Variant | Territory |
| --- | --- |
| `LAW-S23-001` | Universal / Safe |
| `LAW-S23-002` | Premium / Editorial |
| `LAW-S23-003` | Dense / Information-heavy |
| `LAW-S23-004` | Conversion-led |
| `LAW-S23-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S02 Practice Areas (`S02-practice-areas/`).
