...
| Variant | Territory |
| --- | --- |
| `LAW-S21-001` | Universal / Safe |
| `LAW-S21-002` | Premium / Editorial |
| `LAW-S21-003` | Dense / Information-heavy |
| `LAW-S21-004` | Conversion-led |
| `LAW-S21-005` | Sector-native / Distinctive |
