...
| Variant | Territory |
| --- | --- |
| `LAW-S22-001` | Universal / Safe |
| `LAW-S22-002` | Premium / Editorial |
| `LAW-S22-003` | Dense / Information-heavy |
| `LAW-S22-004` | Conversion-led |
| `LAW-S22-005` | Sector-native / Distinctive |
