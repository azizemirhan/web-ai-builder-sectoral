...
| Variant | Territory |
| --- | --- |
| `RE-S27-001` | Universal / Safe |
| `RE-S27-002` | Premium / Editorial |
| `RE-S27-003` | Dense / Information-heavy |
| `RE-S27-004` | Conversion-led |
| `RE-S27-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S17 Office Locations (`S17-office-locations/`).
