...
| Variant | Territory |
| --- | --- |
| `RE-S25-001` | Universal / Safe |
| `RE-S25-002` | Premium / Editorial |
| `RE-S25-003` | Dense / Information-heavy |
| `RE-S25-004` | Conversion-led |
| `RE-S25-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S14 Market Insights (`S14-market-insights/`).
