...
| Variant | Territory |
| --- | --- |
| `RE-S23-001` | Universal / Safe |
| `RE-S23-002` | Premium / Editorial |
| `RE-S23-003` | Dense / Information-heavy |
| `RE-S23-004` | Conversion-led |
| `RE-S23-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S13 Real Estate Services (`S13-real-estate-services/`).
