...
| Variant | Territory |
| --- | --- |
| `RE-S26-001` | Universal / Safe |
| `RE-S26-002` | Premium / Editorial |
| `RE-S26-003` | Dense / Information-heavy |
| `RE-S26-004` | Conversion-led |
| `RE-S26-005` | Sector-native / Distinctive |
...
Nearest existing section in this sector: S04 Agents Advisors (`S04-agents-advisors/`).
